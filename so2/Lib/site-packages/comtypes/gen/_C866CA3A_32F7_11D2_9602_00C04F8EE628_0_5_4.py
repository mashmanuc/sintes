...
__all__ = [
    'DISPID_SpeechObjectToken', 'SPEI_REQUEST_UI',
    'DISPID_SPARecoResult', 'SVPNormal', 'DISPID_SVEViseme',
    'SPBO_TIME_UNITS', 'DISPID_SGRAddState',
    'DISPID_SRCVoicePurgeEvent', 'SGRSTTRule', 'SpLexicon',
    'DISPID_SPRs_NewEnum', 'SPPS_RESERVED3', 'ISpNotifyTranslator',
    'DISPID_SRCEEndStream', 'SpeechRuleState', 'SAFT8kHz16BitStereo',
    'SpeechCategoryRecoProfiles', 'ISpEventSource', 'DISPID_SVResume',
    'SPSFunction', 'eLEXTYPE_PRIVATE14', 'DISPID_SpeechPhraseRule',
    'SPEI_PHONEME', 'ISpeechPhraseRule', 'SRSInactiveWithPurge',
    'SPEI_START_INPUT_STREAM', 'SPCT_SLEEP', 'SAFTDefault',
    'DISPID_SVEPhoneme', 'DISPID_SPAStartElementInResult',
    'DISPID_SPEEngineConfidence', 'DISPID_SMSADeviceId',
    'SP_VISEME_4', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRRSaveToMemory', 'DISPID_SpeechRecoResult2',
    'SPLOADOPTIONS', 'SAFT44kHz16BitMono', 'ISpeechLexicon',
    'SAFTCCITT_ALaw_22kHzMono', 'SpeechRunState',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpeechLexiconWord', 'SPBO_AHEAD',
    ...
    'DISPID_SPIRetainedSizeBytes', 'SAFTCCITT_ALaw_44kHzStereo',
    'SREHypothesis', 'DISPID_SBSWrite', 'SpUnCompressedLexicon',
    'DISPID_SASetState', 'IInternetSecurityManager',
    'SPSNotOverriden', 'SpeechGrammarWordType', 'ISpeechPhraseInfo',
    'SVP_17', 'ISpAudio', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SRCRetainedAudio', 'SVF_Emphasis', 'ISpRecognizer3',
    'SpeechCategoryVoices', 'SPDKL_CurrentConfig',
    'SpeechTokenValueCLSID', 'DISPID_SVAlertBoundary',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPAO_RETAIN_AUDIO',
    'SpeechCategoryRecognizers', 'SVEViseme',
    'SpeechTokenKeyAttributes', 'DISPID_SPIReplacements',
    'DISPID_SMSALineId', 'DISPID_SpeechGrammarRules',
    'DISPID_SRRSetTextFeedback', 'SPEI_HYPOTHESIS',
    'SAFT22kHz16BitMono', 'SAFTADPCM_8kHzStereo',
    'ISpStreamFormatConverter', 'SPSMF_SAPI_PROPERTIES',
    'SpeechGrammarTagWildcard', 'SpeechTokenKeyFiles',
    'DISPID_SVEVoiceChange', 'SVP_3', 'DISPID_SRGId', 'SP_VISEME_14',
    'SPEI_VISEME', 'DISPID_SPERetainedSizeBytes', 'SPAR_Low',
    'DISPID_SPPParent', 'SpInprocRecognizer', 'SECFNoSpecialChars',
    'DISPID_SpeechCustomStream', 'DISPID_SRRTTickCount',
    'eWORDTYPE_DELETED', 'ISpPhoneticAlphabetConverter',
    'DISPID_SGRSTType', 'Speech_StreamPos_Asap', 'SPEI_RESERVED6',
    'DISPID_SRRTimes', 'SITooSlow', 'SGDSActive',
    'SAFT32kHz16BitStereo', 'DISPID_SPRNumberOfElements',
    'DISPIDSPTSI_SelectionLength', 'SAFTADPCM_11kHzMono',
    'DISPID_SOTDataKey', 'DISPID_SPRText', 'SPEI_END_INPUT_STREAM',
    'SPINTERFERENCE_TOOFAST', 'SpSharedRecoContext', 'SVF_None',
    'DISPID_SpeechXMLRecoResult', 'SpeechPropertyAdaptationOn',
    'SPDATAKEYLOCATION', 'SPPHRASERULE', 'DISPID_SGRsCommitAndSave',
    'SPSERIALIZEDPHRASE', 'DISPID_SpeechRecognizerStatus',
    'eLEXTYPE_PRIVATE6', 'SpeechEmulationCompareFlags', 'SGSEnabled',
    'SPWORDPRONUNCIATION', 'DISPID_SRCResume', 'ISequentialStream',
    'DISPID_SPIProperties', 'SPAUDIOOPTIONS', 'SPGRAMMARSTATE',
    'SAFT11kHz16BitStereo', 'ISpRecoResult',
    'DISPID_SLAddPronunciation', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SVSLastResult', 'SPDKL_DefaultLocation', 'SpMMAudioIn',
    'DISPID_SRCEInterference', 'SPGS_ENABLED', 'eLEXTYPE_RESERVED8',
    'DISPID_SpeechPhraseInfo', 'ISpStream', 'ISpRecoGrammar2',
    'DISPIDSPTSI', 'SpShortcut', 'SPAS_CLOSED',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SDKLLocalMachine', 'SVP_1',
    'DISPID_SVVoice', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SLGenerationId', 'SASStop', 'SPWF_SRENGINE',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRSetPropertyNumber',
    'SVP_11', 'SPPS_Modifier', 'SVEAllEvents',
    'DISPID_SpeechMemoryStream', 'DISPID_SLWPronunciations', 'SVP_7',
    'DISPID_SRGIsPronounceable', 'DISPID_SPPsItem', 'SPEI_MAX_SR',
    ...
    'DISPID_SGRSTText', 'DISPID_SVEAudioLevel',
    'ISpeechPhoneConverter', 'SPEVENTSOURCEINFO',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRSCurrentStreamNumber',
    'SpMemoryStream', 'DISPID_SOTCategory', 'Speech_Max_Word_Length',
    'DISPID_SVRate', 'SVEEndInputStream', 'DISPID_SRGCommit',
    'SPVPRI_NORMAL', 'SPPS_LMA', 'SP_VISEME_11', 'SpAudioFormat',
    'eLEXTYPE_PRIVATE2', 'SRTReSent', '_ISpeechRecoContextEvents',
    'SPFM_CREATE', 'DISPID_SLPs_NewEnum', 'ISpSerializeState',
    'SLODynamic', 'SVP_2', 'SAFT11kHz8BitStereo', 'DISPID_SOTRemove',
    'DISPID_SBSRead', 'SPSNoun', 'SVSFNLPSpeakPunc', 'SPLO_STATIC',
    'SPAR_Unknown', 'SPSERIALIZEDRESULT', 'SINoise',
    'DISPID_SWFEExtraData', 'SPPROPERTYINFO', 'SVEPrivate',
    ...
    'ISpeechAudioFormat', 'SAFTCCITT_uLaw_44kHzMono', 'SPBO_PAUSE',
    'DISPID_SLWsItem', 'SpeechGrammarState', 'SRTStandard',
    'ISpShortcut', 'SP_VISEME_13', 'SPEI_RESERVED1', 'SPEI_UNDEFINED',
    'ISpeechAudioStatus', 'DISPID_SMSGetData', 'DISPID_SAFType',
    'DISPID_SLPType', 'eLEXTYPE_PRIVATE10', 'DISPID_SGRSTWeight',
    'DISPID_SpeechPhraseReplacements', 'SAFT11kHz8BitMono',
    'ISpeechRecognizerStatus', 'DISPID_SpeechPhraseRules',
    'SPRECOSTATE', 'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPEs_NewEnum',
    'DISPID_SRIsShared', 'SVP_18', 'DISPID_SLWType', 'DISPID_SVSkip',
    'DISPID_SRRSpeakAudio', 'SPSVerb', 'DISPID_SLPsItem',
    'ISpGrammarBuilder', 'SPRS_ACTIVE', 'ISpeechVoice',
    'STSF_LocalAppData', 'DISPID_SABufferNotifySize',
    'SPEI_WORD_BOUNDARY', 'SpeechTokenContext', 'SpPhraseInfoBuilder',
    'SpeechMicTraining', 'DISPID_SRGRecoContext', 'DISPID_SRGReset',
    'DISPID_SPRDisplayAttributes', 'SAFT24kHz16BitStereo',
    'DISPID_SPEsCount', '_ISpeechVoiceEvents', 'SGDSInactive',
    'SpMMAudioEnum', 'SpeechPropertyLowConfidenceThreshold',
    'eLEXTYPE_RESERVED6', 'SPSEMANTICERRORINFO',
    'SRERecoOtherContext', 'DISPID_SLGetGenerationChange',
    'SDTProperty', 'DISPID_SRAudioInputStream',
    'SpeechRegistryUserRoot', 'eLEXTYPE_RESERVED4',
    'DISPID_SRGCmdSetRuleState', 'SRADefaultToActive',
    'SREPhraseStart', 'SVSFlagsAsync', 'DISPID_SLPLangId',
    'DISPID_SPIGetText',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SAFSetWaveFormatEx',
    'SP_VISEME_20', 'SAFT44kHz16BitStereo', 'DISPID_SGRSTs_NewEnum',
    'SSTTDictation', 'SP_VISEME_0', 'DISPID_SRRPhraseInfo',
    'SGSDisabled', 'DISPID_SASCurrentSeekPosition',
    'SPPS_Interjection', 'DISPID_SWFEChannels', 'SPRECORESULTTIMES',
    'DISPID_SpeechVoiceStatus', 'ISpRecoContext2', 'SPPS_RESERVED1',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechAudioProperties',
    'SpPhoneticAlphabetConverter', 'DISPID_SRCEAudioLevel',
    'DISPID_SRSSupportedLanguages', 'DISPID_SPPId', 'ISpEventSink',
    'SpeechVisemeType', 'STCRemoteServer',
    'DISPID_SVSInputWordLength', 'SVP_10', 'DISPID_SGRSTRule',
    'DISPID_SGRSTransitions', 'SPFM_NUM_MODES',
    'DISPID_SpeechPhoneConverter', 'SPEI_START_SR_STREAM',
    'DISPID_SRDisplayUI', 'SSSPTRelativeToStart',
    'DISPID_SGRSTPropertyValue', 'STCAll', 'ISpeechPhraseAlternates',
    'SLOStatic', 'ISpeechRecoResultTimes', 'DISPID_SpeechDataKey',
    'DISPID_SPAPhraseInfo', 'SpeechVoiceSpeakFlags', 'SREStreamEnd',
    'DISPID_SOTCreateInstance', 'DISPID_SPPName', 'SPRST_ACTIVE',
    'DISPID_SGRSTsCount', 'SPCT_SUB_DICTATION',
    'SpeechRecoProfileProperties', 'DISPID_SRCCreateGrammar',
    'SRCS_Disabled', 'DISPID_SPCPhoneToId',
    'SpeechCategoryPhoneConverters', 'ISpVoice',
    'SPINTERFERENCE_NONE', 'DISPID_SPRules_NewEnum',
    'SPCT_SUB_COMMAND', 'DISPID_SVGetAudioOutputs', 'ISpRecoCategory',
    'SPSInterjection', 'SpTextSelectionInformation',
    'SpInProcRecoContext', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRGDictationUnload', 'DISPID_SVGetVoices',
    'ISpNotifySink', 'SpeechPropertyHighConfidenceThreshold',
    'tagSPPROPERTYINFO', 'eLEXTYPE_PRIVATE15', 'SpeechLoadOption',
    'SPSModifier', 'DISPID_SGRAddResource', 'ISpObjectToken',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPXMLRESULTOPTIONS',
    'SDA_Two_Trailing_Spaces', 'SREAdaptation', 'STSF_FlagCreate',
    'SPEI_RECOGNITION', 'DISPID_SOTs_NewEnum', 'SREFalseRecognition',
    'DISPID_SpeechObjectTokenCategory', 'SPVISEMES', 'ISpeechAudio',
    'SASClosed', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SGRInitialState', 'DISPID_SRGetPropertyNumber',
    'SRAExport', 'SAFT48kHz8BitMono', 'SGDSActiveWithAutoPause',
    'SINone', 'SAFT44kHz8BitMono', 'SpeechPartOfSpeech',
    'DISPID_SRState', 'DISPID_SpeechAudioFormat', 'SPSHORTCUTPAIR',
    'ISpeechMemoryStream', 'SAFT8kHz8BitMono', 'DISPID_SGRsAdd',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SREmulateRecognition',
    'SVSFIsXML', 'SPRST_ACTIVE_ALWAYS', 'ISpeechGrammarRules',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SRAudioInput',
    'SGRSTTTextBuffer', 'SpCompressedLexicon', 'DISPID_SPRulesItem',
    'DISPID_SPIStartTime', 'DISPID_SpeechRecoContext',
    'DISPID_SVEBookmark', 'SpeechGrammarTagDictation',
    'DISPID_SRRTLength', 'DISPID_SRRAudio', 'DISPID_SPIRule',
    'eWORDTYPE_ADDED', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SOTIsUISupported', 'SAFT16kHz16BitMono', 'SP_VISEME_16',
    'DISPID_SVSpeakCompleteEvent', 'STSF_AppData', 'SRSActiveAlways',
    'SVP_21', 'eLEXTYPE_PRIVATE8', 'SVP_9',
    'ISpeechGrammarRuleStateTransitions',
    'SpeechPropertyResourceUsage', 'eLEXTYPE_PRIVATE3',
    'ISpeechRecoContext', 'DISPID_SDKCreateKey',
    'SPFM_OPEN_READWRITE', 'SP_VISEME_2', 'SGPronounciation',
    'DISPID_SGRId', 'SAFT12kHz16BitStereo', 'SpeechVoiceEvents',
    'DISPID_SVGetAudioInputs', 'SPEI_SR_BOOKMARK',
    'DISPID_SPEAudioSizeBytes', 'SITooLoud', 'SPTEXTSELECTIONINFO',
    'ISpeechPhraseElements', 'SAFTCCITT_ALaw_22kHzStereo',
    'eLEXTYPE_PRIVATE17', 'SpeechBookmarkOptions',
    'DISPID_SpeechLexicon', 'SVSFNLPMask', 'SPCS_ENABLED',
    'Speech_StreamPos_RealTime', 'DISPID_SRCERecognizerStateChange',
    'STCInprocHandler', 'SVSFParseSapi',
    'DISPID_SPERequiredConfidence', 'SPLO_DYNAMIC',
    'DISPID_SRRAlternates', 'SPAUDIOBUFFERINFO', 'DISPID_SOTsItem',
    'SPWORDLIST', 'SPSHORTCUTPAIRLIST', 'DISPID_SRGCmdSetRuleIdState',
    'ISpRecoContext', 'SpeechSpecialTransitionType',
    'DISPID_SRStatus', 'SPCONTEXTSTATE', 'SAFTADPCM_44kHzStereo',
    ...
    'SREPropertyNumChange', 'SPCT_COMMAND', 'DISPID_SWFEFormatTag',
    'SPPS_RESERVED2', 'SRAONone', 'eLEXTYPE_PRIVATE16',
    'SpMMAudioOut', 'eLEXTYPE_PRIVATE20', 'SVP_4',
    'SVESentenceBoundary', 'SVP_5', 'SPPS_Noncontent',
    'DISPID_SDKDeleteKey', 'SRERequestUI', 'SVEAudioLevel',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPIElements',
    'SpObjectTokenCategory', 'SRAImport', 'DISPID_SOTCGetDataKey',
    'SAFTCCITT_uLaw_11kHzMono', 'SPFM_OPEN_READONLY', 'SP_VISEME_1',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpeechCategoryAudioIn',
    'SAFT44kHz8BitStereo', 'eLEXTYPE_RESERVED9',
    'SAFT24kHz8BitStereo', 'SPPHRASE', 'ISpNotifySource',
    'DISPID_SPRuleChildren', 'SpeechCategoryAudioOut',
    'DISPID_SOTSetId', 'SpeechStreamSeekPositionType',
    'DISPID_SOTDisplayUI', 'DISPID_SWFEBlockAlign', 'SVP_14',
    'DISPID_SOTCSetId', 'DISPID_SWFEAvgBytesPerSec',
    ...
    'DISPID_SGRSTPropertyName', 'SRATopLevel', 'SVF_Stressed',
    'SRTSMLTimeout', 'SP_VISEME_17', 'SPEI_TTS_BOOKMARK',
    'SRAORetainAudio', 'SBONone', 'DISPID_SVVolume', 'SVP_19',
    'SRSInactive', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SPEActualConfidence', 'DISPID_SOTRemoveStorageFileName',
    'SPWT_DISPLAY', 'SVSFPersistXML', 'ISpPhrase', 'SPPARTOFSPEECH',
    'SAFTText', 'DISPID_SLWWord', 'SPVPRIORITY', 'ISpStreamFormat',
    'DISPID_SPEAudioSizeTime', 'SECFIgnoreWidth',
    'DISPID_SpeechPhraseElement', 'SAFT22kHz16BitStereo',
    'SREBookmark', 'DISPID_SWFEBitsPerSample', 'SSTTWildcard',
    'eLEXTYPE_PRIVATE5', 'SpeechInterference', 'DISPID_SLWLangId',
    'SDKLCurrentConfig', 'eLEXTYPE_PRIVATE19',
    ...
    'ISpeechWaveFormatEx', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SCSBaseStream', 'SPSHT_EMAIL', 'SREStreamStart',
    'DISPID_SRGDictationLoad', 'DISPID_SPPValue',
    'Speech_Max_Pron_Length', 'SASRun', 'DISPID_SAFGuid',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SASCurrentDevicePosition',
    'LONG_PTR', 'SpeechAudioFormatType', 'SVSFParseMask',
    'SECNormalConfidence', 'ISpeechPhraseAlternate',
    'SPINTERFERENCE_NOSIGNAL', 'SPINTERFERENCE_TOOQUIET', 'SFTInput',
    'DISPID_SGRSAddRuleTransition', 'SREInterference',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFT32kHz8BitMono',
    ...
    'DISPID_SRSetPropertyString', 'SRAInterpreter', 'SPWORD',
    'SPWORDPRONOUNCEABLE', 'SPSHT_OTHER', 'SpeechLexiconType',
    'SPLEXICONTYPE', 'SECLowConfidence', 'SPAS_RUN',
    'DISPID_SPERetainedStreamOffset', 'SAFT12kHz8BitStereo',
    'SWTDeleted', 'UINT_PTR', 'ISpeechPhraseInfoBuilder',
    'SP_VISEME_21', 'IEnumString', 'DISPIDSPTSI_SelectionOffset',
    'SPAR_High', 'SECFEmulateResult', 'SFTSREngine',
    'DISPID_SPPsCount', 'DISPID_SDKGetBinaryValue', 'SDTLexicalForm',
    'SpStream', 'SPWORDPRONUNCIATIONLIST', 'SAFT12kHz8BitMono',
    'SP_VISEME_6', 'IEnumSpObjectTokens', 'SpeechAudioState',
    'DISPID_SRCERecognition', 'SpeechDiscardType', 'DISPID_SLPsCount',
    'SpeechVisemeFeature', 'ISpeechDataKey', 'SP_VISEME_8',
    ...
    'DISPID_SDKOpenKey', 'DISPID_SGRsItem', 'IStream',
    'DISPID_SVIsUISupported', 'Speech_Default_Weight',
    'DISPID_SRGState', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SLRemovePronunciation', 'SpeechCategoryAppLexicons',
    'SPEI_FALSE_RECOGNITION', 'SPPHRASEREPLACEMENT', 'SASPause',
    'DISPID_SPRFirstElement', 'eLEXTYPE_PRIVATE4', 'SRSEIsSpeaking',
    'SGSExclusive', 'DISPID_SRRecognizer', 'SpVoice', 'SpObjectToken',
    'SREAudioLevel', 'SSTTTextBuffer',
    'DISPID_SVSyncronousSpeakTimeout', 'SDTAll',
    'SPXRO_Alternates_SML', 'SPWORDTYPE', 'SBOPause', 'SpFileStream',
    'DISPID_SpeechAudioStatus', 'ISpeechLexiconPronunciations',
    'SPINTERFERENCE_NOISE', 'ISpMMSysAudio', 'SDA_No_Trailing_Space',
    'SREPropertyStringChange', 'SpNullPhoneConverter',
    'ISpeechXMLRecoResult', 'DISPID_SpeechLexiconWords',
    'DISPID_SOTGetStorageFileName', 'SPPS_Verb', 'SPFILEMODE',
    'DISPID_SGRSRule', 'DISPIDSPTSI_ActiveLength',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SRCCreateResultFromMemory',
    'SPSHT_Unknown', 'SAFT16kHz8BitMono', 'DISPID_SRCRequestedUIType',
    'DISPID_SGRsCommit', 'DISPID_SLPSymbolic', 'SECFIgnoreKanaType',
    'SSFMOpenForRead', 'DISPID_SPIGrammarId', 'ISpeechLexiconWords',
    'SPCS_DISABLED', 'ISpeechLexiconPronunciation',
    'SAFTNoAssignedFormat', 'eLEXTYPE_RESERVED7',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SPRuleFirstElement',
    ...
    'SP_VISEME_10', 'SP_VISEME_3', 'eLEXTYPE_PRIVATE13',
    'SPSTREAMFORMATTYPE', 'SAFT16kHz16BitStereo', 'SVP_16',
    'SpeechStreamFileMode', 'SPPHRASEPROPERTY', 'SAFT24kHz16BitMono',
    'DISPID_SPAs_NewEnum', 'SpPhoneConverter', 'ISpeechObjectToken',
    'DISPID_SpeechFileStream', 'SRERecognition', 'SITooQuiet',
    '_SPAUDIOSTATE', 'DISPID_SASNonBlockingIO', 'eLEXTYPE_PRIVATE1',
    'SVP_15', 'DISPID_SRGetRecognizers',
    'SWPUnknownWordPronounceable', 'ISpeechMMSysAudio',
    'DISPID_SGRSTNextState', 'ISpeechResourceLoader',
    'SVEStartInputStream', 'DISPID_SpeechAudioBufferInfo',
    'SPWT_PRONUNCIATION', 'ISpeechFileStream', 'SPPS_NotOverriden',
    'SpeechDataKeyLocation', 'DISPID_SRCEPhraseStart',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_MIN_SR',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SPRuleParent',
    'DISPID_SRCESoundEnd', 'SRTEmulated', 'SPEI_INTERFERENCE',
    'SVEVoiceChange', 'DISPID_SVSLastBookmark', 'SDTReplacement',
    'SAFTNonStandardFormat', 'SPSHT_NotOverriden',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SpeechPhraseElements',
    'SVSFParseAutodetect', 'DISPID_SVEventInterests',
    'DISPID_SVSPhonemeId', 'SpeechAudioVolume', 'SPXRO_SML',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPEI_END_SR_STREAM', 'ISpXMLRecoResult',
    'SDA_Consume_Leading_Spaces', 'DISPID_SAEventHandle', 'SITooFast',
    'DISPID_SpeechVoice', 'eLEXTYPE_USER',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPRsItem',
    'SAFTGSM610_11kHzMono', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'ISpeechGrammarRule', 'SPEVENTENUM', 'DISPID_SPPFirstElement',
    'SPINTERFERENCE_TOOLOUD', 'SGLexicalNoSpecialChars',
    'DISPID_SGRName', 'SAFTTrueSpeech_8kHz1BitMono',
    ...
    'DISPID_SPAsItem', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SDKGetlongValue', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SpeechLexiconWord', 'SVP_6', 'DISPID_SPACommit',
    'DISPID_SPEsItem', 'SVP_13', 'eLEXTYPE_RESERVED10',
    'DISPID_SOTGetAttribute', 'SVSFVoiceMask',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SLGetPronunciations',
    'DISPID_SPRulesCount', 'DISPID_SRRAudioFormat',
    'ISpeechPhraseReplacement', 'eLEXTYPE_PRIVATE12', 'SRARoot',
    'SPCATEGORYTYPE', 'SPEI_RESERVED5', 'DISPID_SGRSTPropertyId',
    'SPEI_PHRASE_START', 'SAFT48kHz8BitStereo', 'DISPID_SMSAMMHandle',
    ...
    'SREStateChange', 'SPAS_STOP', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPCIdToPhone', 'SDTDisplayText', 'SPRULESTATE',
    'DISPID_SRCEEnginePrivate', 'DISPID_SVSInputWordPosition',
    'SpeechFormatType', 'SpeechRecoEvents',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SLPPhoneIds',
    'DISPID_SpeechAudio', 'SRTExtendableParse', 'DISPID_SGRs_NewEnum',
    'SAFT16kHz8BitStereo', 'DISPID_SPELexicalForm',
    'SpSharedRecognizer', 'SPAO_NONE', 'SDTPronunciation',
    'SVEPhoneme', 'SAFT22kHz8BitMono', 'SAFT24kHz8BitMono',
    ...
    'SP_VISEME_5', 'SPINTERFERENCE', 'SVSFIsNotXML',
    'SAFTCCITT_ALaw_11kHzMono', 'SP_VISEME_7',
    'DISPID_SpeechPhraseProperties', 'SVSFUnusedFlags',
    'DISPID_SVEStreamStart', 'SpeechAllElements', 'SVSFIsFilename',
    ...
    'DISPID_SpeechPhraseAlternate', 'SpeechDictationTopicSpelling',
    'ISpeechRecoResult', 'SSFMCreateForWrite', 'ISpeechRecognizer',
    'SP_VISEME_19', 'DISPID_SRCEStartStream', 'SRESoundEnd',
    'SPWT_LEXICAL', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SBSSeek', 'DISPID_SVSVisemeId', 'SVP_8', 'SVEBookmark',
    ...
    'ISpeechGrammarRuleState', 'DISPID_SRGSetTextSelection',
    'DISPID_SGRClear', 'DISPID_SOTsCount', 'DISPID_SVWaitUntilDone',
    'SGLexical', 'SPPHRASEELEMENT', 'SpeechRecognizerState',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRCPause',
    'DISPID_SVEEnginePrivate', 'STCLocalServer', 'DISPID_SVStatus',
    'SDTAudio', 'DISPID_SPEAudioTimeOffset', 'SpResourceManager',
    'DISPID_SpeechRecoResultTimes', 'SGRSTTDictation',
    'SPRECOGNIZERSTATUS', 'ISpeechObjectTokenCategory',
    'SPRS_INACTIVE', 'ISpeechAudioBufferInfo', 'SPBO_NONE',
    'SpStreamFormatConverter', 'DISPID_SpeechVoiceEvent',
    'DISPID_SpeechObjectTokens', 'SVPAlert', 'SGRSTTWord',
    'SECFIgnoreCase', 'SGRSTTWildcard', 'STCInprocServer',
    'DISPID_SOTMatchesAttributes', 'SGDisplay', 'ISpRecognizer2',
    'SpeechEngineProperties', 'DISPID_SABIMinNotification',
    'SpWaveFormatEx', 'SpeechRuleAttributes',
    'DISPID_SRCCmdMaxAlternates', 'SRSEDone', 'ISpeechPhraseProperty',
    'SpeechRecognitionType', 'DISPID_SRSCurrentStreamPosition',
    'SLTUser', 'ISpPhoneticAlphabetSelection', 'ISpRecognizer',
    'SPSEMANTICFORMAT', 'DISPID_SLWs_NewEnum', 'SRADynamic', 'SLTApp',
    'SpeechRecoContextState', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_SR_PRIVATE', 'SECHighConfidence', 'ISpeechVoiceStatus',
    'SpCustomStream', 'ISpResourceManager',
    'SpeechPropertyNormalConfidenceThreshold', 'SPDKL_CurrentUser',
    'SPAS_PAUSE', 'DISPID_SVAudioOutput', 'DISPID_SDKDeleteValue',
    'DISPID_SGRSTsItem', 'SVP_20', 'SPEI_RESERVED3',
    'DISPID_SPANumberOfElementsInResult',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFTGSM610_8kHzMono',
    'SSFMOpenReadWrite', 'DISPID_SDKSetStringValue', 'SPEI_MIN_TTS',
    'eLEXTYPE_PRIVATE7', 'SRTAutopause', 'SPRULE', 'SDTRule',
    'SPWAVEFORMATTYPE', 'SGDSActiveUserDelimited',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SOTCDefault',
    'SPAR_Medium', 'SRCS_Enabled', 'ISpeechPhraseProperties',
    'DISPID_SRCEHypothesis', 'SPSSuppressWord', 'DISPID_SPPs_NewEnum',
    'SPAUDIOSTATE', 'SPEI_MAX_TTS', 'SPWF_INPUT',
    'DISPID_SPPConfidence', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SLGetWords', 'SAFT11kHz16BitMono', 'eLEXTYPE_PRIVATE18',
    'SAFT32kHz8BitStereo', 'SVSFPurgeBeforeSpeak',
    'SPADAPTATIONRELEVANCE', 'DISPID_SAStatus', 'SpeechUserTraining',
    'eLEXTYPE_PRIVATE9', 'SP_VISEME_12', 'SPVOICESTATUS',
    'SDTAlternates', 'DISPID_SpeechPhraseProperty',
    'DISPID_SPPChildren', 'SPBOOKMARKOPTIONS', 'SVEWordBoundary',
    'DISPID_SRGRules', 'SVP_12', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SRCEBookmark', 'DISPID_SRCESoundStart', 'SPPS_RESERVED4',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SREPrivate',
    'eLEXTYPE_USER_SHORTCUT', 'SECFDefault',
    'DISPID_SPEAudioStreamOffset', 'SAFTGSM610_22kHzMono',
    'SPINTERFERENCE_TOOSLOW', 'eLEXTYPE_APP',
    'SpeechAudioFormatGUIDText', 'DISPID_SVSInputSentenceLength',
    'SPRECOCONTEXTSTATUS', 'SPEVENT', 'SVPOver', 'eLEXTYPE_PRIVATE11',
    ...
    'ISpObjectTokenCategory', 'ISpLexicon', 'SSSPTRelativeToEnd',
    'SPEI_SOUND_START', 'DISPID_SRRTOffsetFromStart',
    'SPEI_SOUND_END', 'DISPID_SRProfile', 'DISPID_SPRuleName',
    'DISPID_SPRuleNumberOfElements', 'SGRSTTEpsilon',
    'DISPID_SVSpeak', 'SPSUnknown', 'SAFT8kHz16BitMono',
    ...
    'SPVPRI_ALERT', 'ISpeechCustomStream', 'DISPID_SFSClose',
    'DISPID_SVSRunningState', 'ISpeechRecoResult2', 'SPVPRI_OVER',
    'DISPID_SPIEnginePrivateData', 'SPSLMA', 'DISPID_SAVolume',
    'DISPID_SASState', 'DISPID_SRCEFalseRecognition',
    'DISPID_SVPause', 'DISPID_SRRDiscardResultInfo',
    ...
    'ISpPhoneConverter', 'DISPID_SVEWord', 'SPRST_NUM_STATES',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpeechPhraseElement',
    'SDKLDefaultLocation', 'SPEI_ADAPTATION', 'SPRST_INACTIVE',
    'SPEI_VOICE_CHANGE', 'DISPID_SFSOpen', 'DISPID_SGRAttributes',
    'SRSActive', 'SWTAdded', 'DISPID_SpeechRecoResult',
    'DISPID_SOTId', 'ISpeechPhraseRules', 'DISPID_SGRsDynamic',
    'DISPID_SRSClsidEngine', 'SPSHORTCUTTYPE', 'SPSMF_UPS',
    'DISPID_SPCLangId', 'SVP_0', 'SAFTGSM610_44kHzMono',
    'DISPID_SPEDisplayText', 'SAFT32kHz16BitMono',
    'DISPID_SRIsUISupported', 'SPPS_Unknown',
    'IInternetSecurityMgrSite', 'SPPS_Noun',
    'DISPID_SPIAudioStreamPosition', 'DISPIDSPRG',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SRGetFormat',
    'DISPID_SVPriority', 'ISpRecoGrammar', 'SpNotifyTranslator',
    'DISPID_SRRGetXMLResult', 'ISpObjectWithToken', 'WAVEFORMATEX',
    'SPEI_TTS_PRIVATE', 'SpeechAddRemoveWord',
    'ISpeechPhraseReplacements', 'ISpPhraseAlt', 'tagSTATSTG',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPEI_RESERVED2', 'SPGS_EXCLUSIVE',
    'SPBINARYGRAMMAR', 'SINoSignal',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRGCmdLoadFromObject', 'SPPS_Function',
    'SAFTADPCM_22kHzMono', 'DISPID_SRRTStreamTime', 'SP_VISEME_18',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SWFESamplesPerSec',
    'DISPID_SPIEngineId', 'SpeechWordType', 'DISPID_SLPPartOfSpeech',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRCERequestUI',
    'SPEI_TTS_AUDIO_LEVEL', 'STSF_CommonAppData', 'DISPID_SPRuleId',
    '__MIDL_IWinTypes_0009', 'DISPID_SVAudioOutputStream',
    'SAFTADPCM_8kHzMono', 'SP_VISEME_15', 'SREAllEvents',
    'DISPID_SGRsFindRule', 'DISPID_SRCSetAdaptationData',
    'SPCT_DICTATION', 'ISpDataKey', 'DISPID_SRCVoice',
    'SAFTCCITT_uLaw_22kHzMono', 'SPGS_DISABLED', 'SVSFDefault'
]

_check_version('1.1.14', 1617975871.799457)
